const secretKeyPattern = /^(authorization|api[-_]?key|password|private[-_]?key|secret|access[-_]?token|refresh[-_]?token|token)$/i;
const bearerPattern = /Bearer\s+[A-Za-z0-9._~+/=-]+/gi;
const knownCredentialPattern = /\b(sk-[A-Za-z0-9_-]{16,}|gh[pousr]_[A-Za-z0-9_]{16,})\b/g;
